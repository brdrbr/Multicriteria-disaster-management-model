...
T, K, N, nS, nD, nN, nT, nK, nE, B, Sikt, djkt, Cijkt, uijt, blocked, bt, aij, edge_dict = data_reader.data_read('/Users/yaseminsavas/Multicriteria-disaster-management-model/data/disaster_data.xlsx', mode="Excel")
